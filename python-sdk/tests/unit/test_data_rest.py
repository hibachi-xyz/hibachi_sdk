...
payload = {
    ...
    "maintenanceWindow": [
        {"begin": 1760018400.0, "end": 1760025600.0, "note": "Updating system"}
    ],
    "instantWithdrawalLimit": {
        "lowerLimit": "0.1805267728796",
        "upperLimit": "35154.4178512",
    },
    "status": "NORMAL",
}
...
def test_get_exchange_info():
    ...
    assert info.feeConfig.depositFees == "0.006769"
    # TODO fully test output
